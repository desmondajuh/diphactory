...
const containerClasses =
  "relative w-full h-full flex rotate-[30deg] origin-bottom-left will-change-transform p-8  flex-col";
    ...
    <div className="relative">
      ...
      <div ref={containerRef} className="relative">
        <section className={cn("one", sectionClasses)}>
          <div className={cn("scroll-container", containerClasses, "rotate-0")}>
            <ContentLabel
              step={1}
              label="My Process"
              tag="How I Work"
        ...
        <section className={cn("two", sectionClasses)}>
          <div className={cn("scroll-container", containerClasses)}>
            <ContentLabel
              step={2}
              label="Creative Direction"
              tag="Planning"
        ...
        <section className={cn("three", sectionClasses, "h-[125svh]")}>
          <div className={cn("scroll-container", containerClasses)}>
            <ContentLabel
              step={3}
              label="The Shoot"
...
const ContentLabel = ({
  ...
  return (
    <>
      <div
        className="process-label font-light leading-[0.92] tracking-[-0.03em] absolute top-12 right-12 text-white select-none pointer-events-none"
      ...
      <div className="absolute bottom-0 left-0 px-10 pb-16 md:px-16 md:pb-20 max-w-2xl z-10">
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <span className="process-tag font-bold tracking-[0.18em] text-[0.65rem] uppercase text-white/60">
            {tag}
          </span>
        </div>
        ...
        {/* Headline */}
        <h2
          className="process-label text-white mb-6 font-light leading-[0.92] tracking-[-0.03em]"
        ...
        >
          <p className="process-sub font-normal tracking-[0.01em] leading-[1.6] text-[0.85rem] text-white/70 flex-1">
            {sub}
          </p>
          <a
            href="#contact"
            className="process-tag font-bold tracking-[0.18em] text-[0.65rem] uppercase text-white whitespace-nowrap px-4 py-2 rounded-sm transition-colors"
            style={{
              background: accent,
              color: "#fff",
